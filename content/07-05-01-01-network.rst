...
در ضمن کتاب `Foundations of Python Network Programming <http://www.amazon.com/Foundations-Python-Network-Programming-comprehensive/dp/1430230037/>`_ به صورت مفصل تر به این موضوع پرداخته است، در این کتاب به پکیج‌های مفیدی اشاره شده که بعضی از آنها عبارتند از:
